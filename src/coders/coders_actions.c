...
static void	wait_until_compile(t_coder *coder)
{
	coder->next_event_time = (calculate_time(coder->flags->start_time)
			+ (long long)(coder->flags->time_to_compile));
